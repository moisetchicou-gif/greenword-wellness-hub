...
export const products: Product[] = [
  ...
  { id: 65, name: "Mala Power", image: productMalaPower, benefits: ["Booste l'énergie naturelle", "Soutient la vitalité quotidienne"], price: "10 725 FCFA", priceNum: 10725, oldPrice: "15 300 FCFA", oldPriceNum: 15300, discount: 30, category: "Compléments de santé", bv: 15 },
  ...
  { id: 73, name: "Blood Cleanse Capsule", image: productBloodCleanse, benefits: ["Purifie le sang", "Améliore la circulation sanguine"], price: "20 020 FCFA", priceNum: 20020, oldPrice: "25 000 FCFA", oldPriceNum: 25000, discount: 20, category: "Compléments de santé", bv: 28 },
  ...
  { id: 10, name: "Kuding Plus Tea", image: productKudingTea, benefits: ["Détoxifie l'organisme", "Réduit l'inflammation"], price: "8 580 FCFA", priceNum: 8580, oldPrice: "11 400 FCFA", oldPriceNum: 11400, discount: 25, category: "Thés & Boissons", bv: 12, posologie: "1-3 sachet(s) par jour.", conseils: "Pour les personnes ayant des niveaux élevés de lipides sanguins ou de tension artérielle, des maux de gorge ou des maux de tête, sujettes au rhume ou à la grippe." },
  ...
  { id: 89, name: "Blueberry Concentrate", image: productBlueberryConcentrate, benefits: ["Protège et améliore la vision", "Puissant antioxydant anti-âge", "Favorise la santé intestinale"], price: "58 500 FCFA", priceNum: 58500, category: "Thés & Boissons", bv: 82, posologie: "1 flacon par jour. Format : 30 ml × 12 flacons.", conseils: "Les anthocyanes du Concentré de Myrtilles Green World améliorent la microcirculation rétinienne et la régénération de la rhodopsine, protégeant ainsi la vision. Ce concentré favorise la santé intestinale en stimulant le péristaltisme et nourrit la peau. Antioxydants puissants, les anthocyanes neutralisent les radicaux libres et préviennent les maladies liées au stress oxydatif (maladies inflammatoires, neurodégénératives et cancer). Recommandé pour tous les âges, les personnes malvoyantes, celles souffrant de constipation, ou atteintes de maladies liées au stress oxydatif (Alzheimer, Parkinson, diabète, polyarthrite rhumatoïde, maladies neurodégénératives)." },
  { id: 90, name: "Café de Cordyceps", image: productCafeCordyceps, benefits: ["Stimulant et énergisant efficace", "Réduit la fatigue mentale et physique", "Stimule le système immunitaire"], price: "10 500 FCFA", priceNum: 10500, category: "Thés & Boissons", bv: 15, posologie: "1 à 2 sachet(s) par jour. Versez 1 sachet (15 g) dans 150 ml d'eau chaude, mélangez et dégustez. Format : 180 g (15 g × 12 sachets).", conseils: "Café instantané à la poudre de Cordyceps. Stimulant et énergisant efficace, il réduit la sensation de fatigue mentale et physique, contribue à stimuler le système immunitaire et participe au traitement des maladies respiratoires. Idéal pour les personnes fatiguées, stressées ou ayant besoin d'un regain d'énergie naturel au quotidien." },
