...
export const products: Product[] = [
  ...
  { id: 17, name: "Ganoderma Plus Capsule", image: productGanoderma, benefits: ["Renforce l'immunité", "Soutient la santé respiratoire"], price: "16 445 FCFA", priceNum: 16445, category: "Compléments de santé", bv: 23, posologie: "1 à 2 gélules à chaque fois, 1 à 2 fois par jour.", conseils: "Pour ceux qui viennent de terminer une chimio ou une radiothérapie et les personnes souffrant de maladies hépatiques chroniques." },
  ...
  { id: 33, name: "Eye Care Softgel", image: productEyeCare, benefits: ["Protège la vision", "Prévient la dégénérescence maculaire"], price: "20 020 FCFA", priceNum: 20020, category: "Compléments de santé", bv: 28, posologie: "2 capsules à chaque fois, 1 fois par jour.", conseils: "Pour ceux qui ont des troubles de la vue." },
