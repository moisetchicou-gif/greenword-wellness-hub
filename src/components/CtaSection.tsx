...
const CtaSection = () => {
  return (
    <section id="commander" className="py-24 bg-accent text-accent-foreground relative overflow-hidden">
      ...
      <div className="absolute -bottom-10 -left-10 w-40 h-40 rounded-full bg-primary/5" />

      <div className="container mx-auto px-6 text-center space-y-8 relative">
        <p className="text-primary/70 text-xs font-semibold uppercase tracking-[0.2em]">Commander</p>
        <h2 className="text-3xl sm:text-4xl font-display">
          Prêt à transformer votre santé ?
        </h2>
        <p className="max-w-lg mx-auto opacity-80 text-sm leading-relaxed">
          Commandez dès aujourd'hui vos produits Green World. Satisfait ou remboursé pendant 30 jours.
        </p>

        <div className="pt-2">
          <a href="#produits" className="inline-block bg-secondary text-accent px-8 py-3.5 rounded-full font-medium text-sm tracking-wide hover:opacity-90 active:scale-[0.97] transition-all shadow-lg">
        ...
        <div id="contact" className="grid sm:grid-cols-2 gap-3 max-w-2xl mx-auto pt-6">
          <a href="tel:+2252733747334" className="flex items-center gap-3 bg-accent-foreground/5 backdrop-blur-sm rounded-xl p-4 hover:bg-accent-foreground/10 transition-colors border border-accent-foreground/10">
          ...
          <a href="https://wa.me/2250715736370" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-accent-foreground/5 backdrop-blur-sm rounded-xl p-4 hover:bg-accent-foreground/10 transition-colors border border-accent-foreground/10">
          ...
          <a href="mailto:greenworldkr25@gmail.com" className="flex items-center gap-3 bg-accent-foreground/5 backdrop-blur-sm rounded-xl p-4 hover:bg-accent-foreground/10 transition-colors border border-accent-foreground/10">
          ...
          <a href="https://share.google/tqV7vorkQ4N4yP3jb" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-accent-foreground/5 backdrop-blur-sm rounded-xl p-4 hover:bg-accent-foreground/10 transition-colors border border-accent-foreground/10">
          ...
          <div className="flex flex-wrap justify-center gap-5">
            {[
              ...
              <div key={method.name} className="flex flex-col items-center gap-2">
                <div className="w-14 h-10 rounded-lg bg-accent-foreground/90 flex items-center justify-center shadow-md overflow-hidden p-1.5">
                  <img src={method.logo} alt={method.name} className="w-full h-full object-contain" />
                </div>
                <span className="text-[10px] opacity-60">{method.name}</span>
              </div>
            ))}
          </div>
        </div>
