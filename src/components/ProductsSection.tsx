...
const products = [
  ...
  { id: 7, name: "Glucoblock", image: productGlucoblock, benefits: ["Régule la glycémie", "Soutient la fonction pancréatique"], price: "12 900 FCFA", priceNum: 12900 },
  { id: 8, name: "Zinc Adulte", image: productZincAdulte, benefits: ["Renforce le système immunitaire", "Favorise la santé de la peau"], price: "11 400 FCFA", priceNum: 11400 },
  { id: 9, name: "Cordyceps", image: productCordyceps, benefits: ["Augmente l'énergie et la vitalité", "Régule le système immunitaire"], price: "14 300 FCFA", priceNum: 14300 },
  { id: 10, name: "Kuding Tea", image: productKudingTea, benefits: ["Détoxifie l'organisme", "Réduit l'inflammation"], price: "8 600 FCFA", priceNum: 8600 },
  { id: 11, name: "Pine Pollen", image: productPinePollen, benefits: ["Stimule la vitalité masculine", "Riche en nutriments essentiels"], price: "10 000 FCFA", priceNum: 10000 },
  { id: 12, name: "Vigeur Capsule", image: productVigeurCapsule, benefits: ["Renforce la vitalité masculine", "Améliore l'endurance et la stamina"], price: "18 600 FCFA", priceNum: 18600 },
  { id: 13, name: "Clear (Dentifrice)", image: productClear, benefits: ["Prévient les caries et blanchit les dents", "Élimine la mauvaise haleine"], price: "7 500 FCFA", priceNum: 7500 },
];
