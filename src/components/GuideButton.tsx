...
const GuideButton = () => {
  ...
  return (
    <Link
      ...
      className="fixed bottom-24 right-4 z-40 flex items-center gap-2 px-4 py-2.5 rounded-full bg-primary text-primary-foreground text-xs font-semibold shadow-lg shadow-primary/30 hover:scale-110 hover:shadow-xl hover:shadow-primary/40 active:scale-[0.95] transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] animate-slide-up-fade"
