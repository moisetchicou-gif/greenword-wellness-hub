    ...
    <footer id="contact" className="py-16 bg-foreground text-primary-foreground/70">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-10">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="font-display text-xl text-primary-foreground">Green World</span>
            </div>
            <p className="text-sm leading-relaxed">
              Votre partenaire santé naturel en Côte d'Ivoire.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <a href="mailto:greenworldkr25@gmail.com" className="flex items-center gap-3 hover:text-primary-foreground transition-colors">
        ...
        <div className="border-t border-primary-foreground/10 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs">© 2026 Green World. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
